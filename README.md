...
In the fast-paced retail universe, performance isn't just about flashy numbers. it's about the narrative behind them. This dashboard takes you behind the curtain, revealing the *real* story of an activewear company’s journey across multiple years of operations.
...
|--------|-------|-----------|
| **Total Revenue** | \$908.91K | 🔼 +37.51% |
| **Total Profit** | \$273.23K | 🔼 +37.53% |
| **Quantity Sold** | 19K | 🔼 +37.81% |
| **Customer Count** | 5K | 🔼 +35.32% |

These aren’t just numbers, they’re signals. Signals of upward momentum, customer loyalty, and regional performance ripe for deeper digging.
...
There’s no fixed seasonal pattern meaning **external factors like promotions, regional campaigns, or product drops are likely driving these spikes**.
...
Here’s the profit breakdown by where customers shop:
...
While most products perform decently, **Sports Bras are lagging** has records of two consecutive years of weak profit contribution. That’s a red flag. Whether it’s pricing, marketing, or customer demand, this line needs a turnaround plan or a potential phase-out strategy.
...
- **Power BI Desktop** – for dynamic visual storytelling
- **DAX** – to calculate YoY metrics, growth %, and advanced KPIs
- **Slicer Filters** – region, channel, product, and time-based toggles
- **Custom Date Table** – for time intelligence magic
- **Tooltip Pages** – for extra drill-down without overwhelming the main visuals
...
### 1. Sports Bra Product Performance – Immediate Intervention Required
...
- Perform a **competitive benchmark**: Compare this product line’s performance against competitors in the same price/quality bracket.
- Based on findings:
...
### 2. Marketplaces Are Winning – Scale with Purpose

**Insight**: Marketplaces generated the highest profit across all sales channels. This wasn’t just a one-year fluke. They’ve consistently outperformed other channels in profitability and growth trajectory.
...
### 3. California as a Growth Blueprint – Replicate & Localize
...
**Recommended Action**:
- Deep-dive into California’s operational model: Investigate marketing campaigns, local influencers, shipping/logistics efficiency, and regional demand patterns.
- Identify **customer personas unique to California** and match them against other high-potential states.
- Roll out **pilot campaigns** in other regions using California’s best practices tailored to local nuances.

*Goal: Use California’s success playbook as a template for scaling high-performance operations in underperforming but similar states.*

---

### 4. Pop-Ups & Events – Small Channel, Big Potential
...
*Goal: Turn Pop-Ups from a passive income stream into a targeted growth lever — especially in regional markets with low online conversion.*

---

### 5. Unpredictable Profit Peaks – Time to Build a Calendar That Works

**Issue Identified**: Peak profit months vary wildly across the years: January in 2021, March-April in 2022, October-November in 2023, and February in 2024. This suggests profits aren’t following seasonal or promotional consistency.
...
If you love dashboards that tell stories and insights that spark action, let’s link up:

📧 [Email](ogunkoladevictoria7@gmail.com)  
🔗 [LinkedIn](https://www.linkedin.com/in/victoriaogunkolade/)  
